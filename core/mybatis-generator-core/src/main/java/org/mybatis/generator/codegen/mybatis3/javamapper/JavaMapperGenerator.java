...
public class JavaMapperGenerator extends AbstractJavaClientGenerator {
    ...
    public List<CompilationUnit> getCompilationUnits() {
        ...
        FullyQualifiedJavaType fullyQualifiedJavaType=new FullyQualifiedJavaType("GenericDao");
        //fullyQualifiedJavaType.addTypeArgument();
        //fullyQualifiedJavaType.addTypeArgument("");
        FullyQualifiedJavaType paramtype = introspectedTable.getRules()
                .calculateAllFieldsClass();
        fullyQualifiedJavaType.addTypeArgument(paramtype);
        interfaze.addSuperInterface(fullyQualifiedJavaType);
        interfaze.addImportedType(new FullyQualifiedJavaType("com.dojoy.core.generic.GenericDao"));
    ...
    protected void addSelect(Interface interfaze) {
    ...
    protected void addInsert(Interface interfaze) {
        AbstractJavaMapperMethodGenerator methodGenerator = new InsertMethodGenerator();
        initializeAndExecuteGenerator(methodGenerator, interfaze);
    }

    protected void addUpdate(Interface interfaze) {
